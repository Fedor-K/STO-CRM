...
export class UsersController {
  ...
  @ApiQuery({ name: 'excludeRole', required: false, enum: UserRole })
  @ApiQuery({ name: 'search', required: false })
  findAll(@CurrentTenant() tenantId: string, @Query() query: PaginationDto & { role?: UserRole; excludeRole?: UserRole; search?: string }) {
